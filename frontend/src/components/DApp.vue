...
// const hasReward = computed(async() => {
//   return await contract.rewardOf(accountAddress.value).then(res => res != 0)
// })
        ...
        <div v-show="hasReward" class="relative py-3 sm:max-w-sm sm:mx-auto">
          <div class="flex flex-col bg-white px-8 py-6 max-w-sm mx-auto rounded-lg shadow-lg">
            ...
            <div class="mt-4">
              ...
              <div v-show="fundingStage.value == 2" class="relative text-center">
                <button type="button" :class=style.investBtn>Claim</button>
              </div>
              <div v-show="fundingStage.value == 3"  class="relative text-right">
